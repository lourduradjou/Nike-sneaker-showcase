		...
		<section className='max-container flex flex-1 lg:flex-row flex-col-reverse justify-evenly items-center'>
			<div className='mt-8'>
				<img
					...
					width={512}
					heigth={476}
          className='lg:rotate-12 mx-auto'
				/>
			</div>
			<div className='my-2'>
				...
				<p className='info-text  flex-wrap break-words my-4 lg:max-w-lg lg:flex hidden'>
				...
				<p className='info-text  flex-wrap break-words my-4 lg:max-w-lg '>
